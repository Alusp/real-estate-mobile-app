...
class _WebViewExampleState extends State<WebViewExample> {
  ...
  void initState() {
    ...
    controller
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          ...
          onNavigationRequest: (NavigationRequest request) {
            if (request.url.startsWith('https://www.reddit.com/')) {
      ...
      ..loadRequest(Uri.parse('https://senilkrealestate.com/'));
...
//   void initState() {
//     super.initState();
//     image1 = Image.asset('assets/images/roundedlogo.png');
//     Timer(
...
//            body: SafeArea(
//                child: WebView(
//          initialUrl: 'https://senilkrealestate.com/',
